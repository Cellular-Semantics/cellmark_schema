# Contributing to cellmark_schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
cellmark_schema. These guidelines are not strict rules.
...
The cellmark_schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the cellmark_schema technical leads
...
[issues]: https://github.com/my-org/cellmark_schema/issues/
[pulls]: https://github.com/my-org/cellmark_schema/pulls/
